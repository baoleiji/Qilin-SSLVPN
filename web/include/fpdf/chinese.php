...
$GB_widths = array(' '=>207,'!'=>270,'"'=>342,'#'=>467,'$'=>462,'%'=>797,'&'=>710,'\''=>239,
	'('=>374,')'=>374,'*'=>423,'+'=>605,','=>238,'-'=>375,'.'=>334,'/'=>334,'0'=>462,'1'=>462,
	'2'=>462,'3'=>462,'4'=>462,'5'=>462,'6'=>462,'7'=>462,'8'=>462,'9'=>462,':'=>334,';'=>334,
...
var $aligns;
	...
	function FancyTable($header, $data, $w)
	{
		...
		{
			for($i=0; $i<count($w); $i++){
				$this->Cell($w[$i],6,$row[$i],'LR',0,'L',$fill,1);
			}
			$this->Ln();
			$fill = !$fill;
		}
...
function Row($data, $fill)
{
    ...
    for($i=0;$i<count($data);$i++)
    {
        ...
        $this->Rect($x,$y,$w,$h);
        //Print the text
        $this->MBMultiCell($w,5,$data[$i],0,$a, $fill, $nb);
...
function MultiCell($w, $h, $txt, $border=0, $align='L', $fill=0, $maxline=10000)
{
	if($this->CurrentFont['type']=='Type0')
		$this->MBMultiCell($w,$h,$txt,$border,$align,$fill, $maxline=10000);
	else
		parent::MultiCell($w,$h,$txt,$border,$align,$fill);
}

function MBMultiCell($w, $h, $txt, $border=0, $align='L', $fill=0, $maxline=10000)
{
