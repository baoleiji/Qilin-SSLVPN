...
<ul>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				<th class="list_bg"  width="15%">任务名称</th>
			...
			<tr bgcolor="f7f7f7">
				<td>审计文件备份</td>
				<td>
				<img src='{{$template_root}}/images/069.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onclick="loadurl('admin.php?controller=admin_backup&action=cronjob_audit',300);return false;">{{$language.Start}}</a>
			...
			<tr bgcolor="">
				<td>主从服务器备份</td>
				<td>
				<img src='{{$template_root}}/images/069.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onclick="loadurl('admin.php?controller=admin_backup&action=cronjob_mastslav',300);return false;">{{$language.Start}}</a>
			...
			<tr bgcolor="f7f7f7">
				<td>自动删除</td>
				<td>
				<img src='{{$template_root}}/images/069.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onclick="loadurl('admin.php?controller=admin_backup&action=cronjob_autodelete',300);return false;">{{$language.Start}}</a>
