...
<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_log&action=applog_warning">应用告警</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>  
  ...
  <table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
	 <FORM method=post name=list     action=admin.php?controller=admin_countlogs&amp;a=delete_all&amp;t=countlogs_month_server>
				...
				<TH width="5%" class="list_bg"><a href="#"  onClick="searchit('host','{{$orderby2}}');">主机</a></TH>
...
location.href='admin.php?controller=admin_countlogs&action=export&table=log_countlogs_month_server&f_rangeStart='+f_rangeStart;

}

function export2(){
var f_rangeStart = document.getElementById("f_rangeStart").value;
location.href='admin.php?controller=admin_countlogs&action=derivetoHTML&table=log_countlogs_month_server&f_rangeStart='+f_rangeStart;
}
</script>
</body>
</html>
