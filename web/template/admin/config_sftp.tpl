...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="main_content">SFTP{{$language.Configure}} &nbsp;&nbsp;&nbsp; <input type="button"  value="ssh" onclick="javascript:document.location='admin.php?controller=admin_config&action=config_ssh';" class="an_02">&nbsp;&nbsp;&nbsp;
	...
	<input type="button"  value="sftp" onclick="javascript:document.location='admin.php?controller=admin_config&action=config_sftp';" class="an_02">&nbsp;&nbsp;&nbsp;
   ...
   {{* <input type="button"  value="RDP" onclick="javascript:document.location='admin.php?controller=admin_config&action=config_rdp';" class="an_02">&nbsp;&nbsp;&nbsp;
    <input type="button"  value="Radius" onclick="javascript:document.location='admin.php?controller=admin_config&action=radius';" class="an_02">&nbsp;&nbsp;&nbsp;
     <input type="button"  value="{{$language.LoginTimeout}}" onclick="javascript:document.location='admin.php?controller=admin_config&action=logintimeout';" class="an_02">&nbsp;&nbsp;&nbsp;*}}
             <input type="button"  value="密码策略" onclick="javascript:document.location='admin.php?controller=admin_config&action=login_times';" class="an_02">&nbsp;&nbsp;&nbsp;
...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_config&action=sftp_save">
	...
	<tr bgcolor="f7f7f7"><td>堡垒机备份阈值:</td>
		<td align=left>
