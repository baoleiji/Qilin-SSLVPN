...
<ul>
	...
	{{/if}}
	{{/if}}
</ul><span class="back_img"><A href="admin.php?controller=admin_config&action=apppub_list&gid={{$gid}}&appserverip={{$appserverip}}&device_ip={{$smarty.get.device_ip}}&back=1"><IMG src="{{$template_root}}/images/back1.png" 
      width="80" height="30" border="0"></A></span>
</div></td></tr>
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
              <form action="admin.php?controller=admin_config&action=doapppubimport&appserverip={{$appserverip}}&device_ip={{$smarty.get.device_ip}}" method="post" enctype="multipart/form-data" >
			  <tr><th colspan="3" class="list_bg">导入应用发布：</th></tr>
		<tr >
			<td width="10%" height="16" align="center" ><b>文件</b></td>
			<td align="left" width="30%">
			<input type="file" name="apppub" />
			</td>
		</tr>	
		<tr >
