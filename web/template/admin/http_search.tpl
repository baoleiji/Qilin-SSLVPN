...
<form method="get" name="session_search" action="admin.php">
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						...
						<td width="100">
							...
							<input type="radio" name="controller" value="admin_http"  checked>Http{{$language.Session}}
							</td><td width="100">
							...
							</td><td><input type="radio" name="controller" value="admin_scp" onClick="location.href='admin.php?controller=admin_scp&action=search'">SCP</td></tr></table>
