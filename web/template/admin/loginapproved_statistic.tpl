...
<ul>
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="#">登录审批</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
...
//cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
	...
	<form name="member_list" action="admin.php?controller=admin_member&action=delete_all" method="post">
					<tr>
						...
						<th class="list_bg"  width="10%" ><a href='admin.php?controller=admin_member&orderby1=realname&orderby2={{$orderby2}}' >用户名</a></th>
						<th class="list_bg"  width="10%" ><a href='admin.php?controller=admin_member&orderby1=realname&orderby2={{$orderby2}}' >别名</a></th>
						<th class="list_bg"  width="10%" ><a href='admin.php?controller=admin_member&orderby1=realname&orderby2={{$orderby2}}' >运维组</a></th>
						<th class="list_bg"  width="10%" ><a href='admin.php?controller=admin_member&orderby1=realname&orderby2={{$orderby2}}' >服务器IP</a></th>
						<th class="list_bg"  width="10%" ><a href='admin.php?controller=admin_member&orderby1=realname&orderby2={{$orderby2}}' >系统用户名</a></th>
						<th class="list_bg"  width="9%"><a href='admin.php?controller=admin_member&orderby1=start_time&orderby2={{$orderby2}}' >登录协议</a></th>
						<th class="list_bg"  width="9%"><a href='admin.php?controller=admin_member&orderby1=start_time&orderby2={{$orderby2}}' >申请时间</a></th>
						<th class="list_bg"  width="9%"><a href='admin.php?controller=admin_member&orderby1=start_time&orderby2={{$orderby2}}' >审批时间</a></th>
						<th class="list_bg"  width="9%"><a href='admin.php?controller=admin_member&orderby1=approveuser&orderby2={{$orderby2}}' >申请人</a></th>
						<th class="list_bg"  width="9%"><a href='admin.php?controller=admin_member&orderby1=start_time&orderby2={{$orderby2}}' >登录时间</a></th>
					</tr>
