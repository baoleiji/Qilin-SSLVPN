  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr >
          ...
          <td height="35" bgcolor="#528AC7" class="main_title">{{$language.ReportManager}}——系统账号报表</td>         
	...
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">策略ID</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">策略名称</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">服务器IP</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">同步用户名</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">原目录</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">新目录</th>
