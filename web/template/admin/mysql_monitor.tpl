...
<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_monitor&action=mysql_monitor">MySQL</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
      ...
      <tr  >
        <td class="" width="100%">
		  ...
		  <TABLE class=BBtable cellSpacing=0 cellPadding=0 width="100%"             align=center>
              ...
              <TR>
                <TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=device_ip&orderby2={{$orderby2}}">设备IP</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=hostname&orderby2={{$orderby2}}">主机名</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=datetime&orderby2={{$orderby2}}">抓取时间</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=app_type&orderby2={{$orderby2}}">参数类型</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=value&orderby2={{$orderby2}}">当前值</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=mail_alarm&orderby2={{$orderby2}}">邮件告警</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=mysql_monitor&orderby1=sms_alarm&orderby2={{$orderby2}}">短信告警</a></TD>
		...
		<TD class="" style="text-align:left">{{if $hosts[h].app_type eq 'questions rate'}}查询速率{{elseif $hosts[h].app_type eq 'open tables'}}打开表数{{elseif $hosts[h].app_type eq 'open files'}}打开文件数{{elseif $hosts[h].app_type eq 'threads'}}连接数{{else}}未定义{{/if}}</TD>
		...
		<TD class="" style="text-align:left"><img src='{{$template_root}}/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_monitor&action=mysql_monitor_edit&id={{$hosts[h].seq}}'>修改</a></TD>		
	  </TR>
	{{sectionelse}}
	   <TR>
