...
<script language="JavaScript">
	...
	$(document).ready(function() {
		var arr = {{$month_detailed}};
		getBar('month_detailed','host','服务器日志统计',arr);
		
		var arr = {{$month_count_srcip}};
		getBar('month_count_srcip','srcip','登录来源地址统计',arr);
		
		var arr = {{$month_count_server}};
		getBar('month_count_server','server','登陆服务器',arr);
		
		var arr = {{$month_count_protocol}};
		getBar('month_count_protocol','protocol','目标协议',arr);
		
		var arr = {{$month_level}};
		getPie('month_level','level','级别(天)',arr);
     ...
     <INPUT id="controller " value=admin_countlogin type=hidden name=c>
      <INPUT id=action value=index type=hidden   name=a> 	
            <select name="type" onchange="window.location='admin.php?controller=admin_countlogs&action='+this.value">
			 ...
			 <option value='weekgraph' >周</option>
			 <option value='monthgraph' selected>月</option>
			 </select>
	</FORM>
</td>
  </tr>
	...
	<tr >
					<td >
								<table width="100%" style="height:330px;"  class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="month_count_srcip" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td >
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="month_count_server" style="width: 100%; height:80%; margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td >
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="month_count_protocol" style="width: 100%; height:80%; margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
	...
	<tr >
					<td  width="33%" >
							<table width="100%"  style="height:330px;" class="BBtable">
									...
									<tr>
										<td  style="height:90%;" > 
										 <div id="month_detailed" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td  width="33%">
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="month_level" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
