...
<td valign="middle" class="hui_bj" >
	<div class="menu">
	<ul>
<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eventlogs">报警查询</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>
...
<td   width=100%>
  <FORM method="post" enctype="multipart/form-data" 
            action="admin.php?controller=admin_eventlogs&action=do_import">
