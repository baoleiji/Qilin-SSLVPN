	...
	<form name="ip_list" action="admin.php?controller=admin_workflow&action=workflow_delete" method="post">
                <TBODY>
                  <TR>
                    ...
                    <th class="list_bg"  width="15%"><a href="admin.php?controller=admin_workflow&action=workflow&orderby1=groupname&orderby2={{$orderby2}}" >描述</a></TD>
			...
			<tr  {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
				...
				<td><img src='{{$template_root}}/images/delete_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onClick="if(!confirm('您确定要删除？')) {return false;} else { location.href='admin.php?controller=admin_workflow&action=workflow_delete&id={{$s[t]['sid']}}';}">删除</a></td>
			</tr>
			{{/section}}
	          <tr>
