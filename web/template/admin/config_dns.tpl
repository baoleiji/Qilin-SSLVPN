...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="main_content">DNS{{$language.Configure}} &nbsp;&nbsp;&nbsp; <input type="button"  value="ssh" onclick="javascript:document.location='admin.php?controller=admin_eth&action=config_ssh';" class="an_02">&nbsp;&nbsp;&nbsp;
    ...
    <input type="button"  value="DNS" onclick="javascript:document.location='admin.php?controller=admin_eth&action=config_dns';" class="an_02">&nbsp;&nbsp;&nbsp;
...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_eth&action=dns_save">
	<tr bgcolor="f7f7f7">
	...
	<tr><td>域名{{$language.Server}}1:</td>
		<td align=left>
		<input type="text" class="wbk" name="nameserver1" value="{{$sshconfig.nameserver1}}" />	
		</td>
		
	</tr>
	<tr bgcolor="f7f7f7"><td>域名{{$language.Server}}2:</td>
		<td align=left>
