	...
	<td align="left" colspan = "7"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="main_content">
		...
		<TBODY>
		 <TR>
			...
			<option value="oracle_disk_monitor" selected>磁盘</option>
			<option value="oracle_diskgroup_monitor" >磁盘组</option>
			</select>
      ...
      <tr  >
        <td class="" width="100%">
		  ...
		  <TABLE class=BBtable cellSpacing=0 cellPadding=0 width="100%"             align=center>
              ...
              <TR>
                <TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=device_ip&orderby2={{$orderby2}}">设备IP</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=hostname&orderby2={{$orderby2}}">主机名称</a></TD>
                <TD width="10%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=datetime&orderby2={{$orderby2}}">抓取时间</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=disk_name&orderby2={{$orderby2}}">磁盘名称</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=disk_path&orderby2={{$orderby2}}">磁盘路径</a></TD>
                <TD width="6%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=total_size&orderby2={{$orderby2}}">总空间</a></TD>
                <TD width="6%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=free_size&orderby2={{$orderby2}}">剩余空间</a></TD>
                <TD width="6%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=mail_alarm&orderby2={{$orderby2}}">邮件告警</a></TD>
                <TD width="6%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_disk_monitor&orderby1=sms_alarm&orderby2={{$orderby2}}">短信告警</a></TD>
                <TD width="6%"  class="list_bg"><a href = "#">操作</a></TD>
              </TR>
