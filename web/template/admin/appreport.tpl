...
{{else}}
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=appreport&number=2">应用报表</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=username&orderby2={{$orderby2}}" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=realname&orderby2={{$orderby2}}" >别名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=groupname&orderby2={{$orderby2}}" >运维组</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=user&orderby2={{$orderby2}}" >系统用户</a></th>						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=appname&orderby2={{$orderby2}}" >应用名称</a></th>
						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=appreport&orderby1=ct&orderby2={{$orderby2}}" >命令次数</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=appreport&orderby1=mstart&orderby2={{$orderby2}}" >开始日期</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=appreport&orderby1=mend&orderby2={{$orderby2}}" >结束日期</a></th>
