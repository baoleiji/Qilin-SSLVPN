	...
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable"><tr>
					...
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">上载次数</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">下载次数</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">命令次数</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">开始日期</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">结束日期</th>
					</tr>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td >{{$reports[t].mstart}}</td>
						<td >{{$reports[t].mend}}</td>
					</tr>
					{{/section}}
