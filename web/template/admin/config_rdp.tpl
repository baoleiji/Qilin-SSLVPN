...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="main_content">RDP{{$language.Configure}} &nbsp;&nbsp;&nbsp;
    <input type="button"  value="ssh" onclick="javascript:document.location='admin.php?controller=admin_config&action=config_ssh';" class="an_02">&nbsp;&nbsp;&nbsp;
...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_eth&action=rdp_save">
	<tr bgcolor="f7f7f7">
