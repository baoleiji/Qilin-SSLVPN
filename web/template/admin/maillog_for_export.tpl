	...
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">邮件地址</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">主题</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">内容</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">附件</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">发送邮件进程</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">发送结果</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">失败原因</th>
					</tr>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td width="10%">{{if $reports[t].status}}成功{{else}}失败{{/if}}</td>
