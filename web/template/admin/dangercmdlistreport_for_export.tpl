  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr >
          ...
          <td height="35" bgcolor="#528AC7" class="main_title">{{$language.ReportManager}}——审计报表</td>         
  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable"><tr>
					...
					<tr>
						<th class="list_bg" bgcolor="d9ecfa" width="10%">序号</TD>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">运维用户</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">别名</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">运维组</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">服务器IP</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">登录协议</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">系统用户</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">告警命令</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">告警级别</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">操作时间</th>
					</tr>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td width="10%">{{if $reports[t].dangerlevel eq 2}}断开连接{{elseif $reports[t].dangerlevel eq 3}}命令警告{{elseif $reports[t].dangerlevel eq 4}}授权命令{{else}}命令阻断{{/if}}</td>
