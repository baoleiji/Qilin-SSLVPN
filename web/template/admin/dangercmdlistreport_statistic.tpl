...
<ul>
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="#">告警操作</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=device_ip&orderby2={{$orderby2}}" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=device_ip&orderby2={{$orderby2}}" >别名</a></th>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=local_user&orderby2={{$orderby2}}" >服务器IP</a></th>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=protocol&orderby2={{$orderby2}}" >系统用户</a></th>							
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=local_user&orderby2={{$orderby2}}" >告警命令</a></th>
