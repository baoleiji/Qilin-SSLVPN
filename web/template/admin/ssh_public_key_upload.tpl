...
<body>
  ...
  <tr>
	<td class="main_content">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><form name="f1" method=post OnSubmit='return check()' enctype="multipart/form-data" action="admin.php?controller=admin_pro&action=ssh_public_key_upload&lid={{$lid}}">
