...
<ul>
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_info">系统利用率</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
...
<body>
	  ...
	  <tr>
		<td class="">
			<iframe id="frame_content" src='{{$url}}' width= "100%" scrolling="no" onload="setScroll();reinitIframe();" frameborder="0" ></iframe>
		</td>
	  </tr>
	</table>
