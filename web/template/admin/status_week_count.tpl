...
function searchit(){
	document.report.action = "admin.php?controller=admin_status&action=week_count";
...
{{/if}}
    <li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_status&action=week_count">周报</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
{{if $smarty.session.ADMIN_LEVEL eq 1 or $smarty.session.ADMIN_LEVEL eq 2}}
...
<input  type="text" class="wbk" name="f_rangeEnd" size="13" id="f_rangeEnd"  value="{{$f_rangeEnd}}" />
 ...
 &nbsp;&nbsp;<input type="submit" height="35" align="middle" onClick="return searchit();" border="0" value=" 确定 " class="bnnew2"/>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg" width="7%">开始日期</th>
						<th class="list_bg" width="7%" >结束日期</th>
						<th class="list_bg"  >SSH并发数</th>
						<th class="list_bg"  >telnet并发数</th>
						<th class="list_bg"  >图形会话并发数</th>
						<th class="list_bg"  >FTP会话并发数</th>
						<th class="list_bg"  >数据库并发数</th>
						<th class="list_bg"  >系统CPU利用率</th>
						<th class="list_bg"  >内存利用率</th>
						<th class="list_bg"  >空间利用率</th>
						<th class="list_bg"  >硬盘利用率</th>
						<th class="list_bg"  >net_eth0_in</th>
						<th class="list_bg"  >net_eth0_out</th>
						<th class="list_bg"  >net_eth1_in</th>
						<th class="list_bg"  >net_eth1_out</th>
						<th class="list_bg"  >week_num</th>
					</tr>
