...
<td width="84%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td valign="middle" class="hui_bj" ><div class="menu" style="width:1100px;">
<ul>
  ...
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
                <TBODY>
                  ...
                  <TR>
                    <th class="list_bg" >组名</th>
                  </TR>

            </tr>
			{{section name=t loop=$alldev}}
			<tr  {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
 <td><a href="admin.php?controller=admin_index&action=main&resgroup={{$alldev[t].groupname}}" >{{$alldev[t].groupname}}</a></td>
