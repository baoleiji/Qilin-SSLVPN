...
<ul>
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="#">命令总计</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=commandreport&orderby1=device_ip&orderby2={{$orderby2}}" >堡垒机用户</a></th>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=commandreport&orderby1=local_user&orderby2={{$orderby2}}" >登录主机</a></th>
