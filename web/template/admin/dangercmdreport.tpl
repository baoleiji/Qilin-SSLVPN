...
function searchit(){
	var url = "admin.php?controller=admin_reports&action=dangercmdreport";
...
{{else}}
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdreport">告警统计</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
	<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdlistreport">告警操作</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>
{{/if}}
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					...
					<th class="list_bg" width="10%">序号</th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=user&orderby2={{$orderby2}}" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=realname&orderby2={{$orderby2}}" >别名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=groupname&orderby2={{$orderby2}}" >运维组</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=luser&orderby2={{$orderby2}}" >系统用户</a></th>						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=device_ip&orderby2={{$orderby2}}" >服务器IP</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=cmd&orderby2={{$orderby2}}" >告警命令</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=ct&orderby2={{$orderby2}}" >命令次数</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=mstart&orderby2={{$orderby2}}" >开始日期</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=dangercmdreport&orderby1=mend&orderby2={{$orderby2}}" >结束日期</a></th>
