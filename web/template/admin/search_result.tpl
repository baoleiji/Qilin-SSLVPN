  			 ...
  			 <TR class="list_tr_bg{{if $smarty.section.t.index % 2 ne 0}}1{{/if}}">
                ...
                <TD class=main_list_td1>{{$result_array[r].host}}</TD>
				 ...
				 <TD class=main_list_td1>{{$result_array[r].priority}}</TD>
				  ...
				  <TD>
				  	<input name="detail" type="button" value="详细"  onclick="javascript:window.open('admin.php?controller=admin_search&action=detail&seq={{$result_array[r].id}}','newwin')" class="bnnew2"  />
