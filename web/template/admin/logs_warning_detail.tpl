...
<td width="100%"   align="center">
	...
	{{assign var="trnumber" value=$trnumber+1}}
	<tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
                     <TD align="right" class=main_list_td1>邮件发送：</TD>
                    <TD align="left" class=main_list_td1>
                   		{{if $detail.mail_status}}成功{{else}}失败{{/if}}
                      </TD>
	</tr>
	{{assign var="trnumber" value=$trnumber+1}}
	<tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
                     <TD align="right" class=main_list_td1>短信发送：</TD>
                    <TD align="left" class=main_list_td1>
                   		{{if $detail.sms_status}}成功{{else}}失败{{/if}}
                      </TD>
	</tr>
	<tr>
