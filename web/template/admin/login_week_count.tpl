...
<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_log&action=applog_warning">应用告警</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>  
      ...
      <INPUT id=action value=index type=hidden   name=action> 	
	   <select name="type" onchange="window.location='admin.php?controller=admin_countlogin&action='+this.value">
 			...
 			<input class="wbk" type="button" id="f_rangeStart_trigger" name="f_rangeStart_trigger" value="选择时间">
		      ...
		      <INPUT  size="12" class="bnnew2"  onClick="JavaScript: document.getElementById('action').value='week';submit();" value=查找  type=button> 
	</FORM>
</td>
  </tr>
</table>	
  ...
  <table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
	 <FORM method=post name=list     action=admin.php?controller=admin_countlogin&amp;a=delete_all&amp;t=login_week_count>
		...
		<TR>
          ...
          <input name="export" type="button" value="导出记录"  onclick="javascript:location.href='admin.php?controller=admin_countlogin&action=export&table=login_week_count'" class="an_02" /> 
          <input name="export" type="button" value="导出html"  onclick="javascript:location.href='admin.php?controller=admin_countlogin&action=derivetoHTML&table=login_week_count'" class="an_02" />   
