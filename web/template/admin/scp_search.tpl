...
<form method="get" name="session_search" action="admin.php">
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						...
						<td width="100">
							...
							<td width="100">
							<input type="radio" name="controller" value="admin_apppub" onClick="location.href='admin.php?controller=admin_apppub&action=urlsearch'">应用URL</td>
							<td><input type="radio" name="controller" value="admin_scp" checked>SCP</td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
					...
					<tr>
						...
						<select  class="wbk"  name="orderby1">
							...
							<option value='cliaddr'>{{$language.SourceAddress}}</option>
							<option value='svraddr'>{{$language.DestinationAddress}}</option>
							<option value='radius_user'>{{$language.Username}}</option>
					...
					<tr>
						...
						<td class="td_line" width="70%"><input name="luser" type="text" class="wbk"></td>
					</tr>
					{{/if}}
					<tr bgcolor="f7f7f7">
						<td class="td_line" width="30%">{{$language.SourceAddress}}：</td>
						<td class="td_line" width="70%">
							<input name="cliaddr" type="text" class="wbk" /><br />
						</td>
					</tr>
					<tr>
						<td class="td_line" width="30%">{{$language.DestinationAddress}}：</td>
						<td class="td_line" width="70%">
							<input name="svraddr" type="text" class="wbk" />&nbsp;{{$language.PleaseinputcorrectAddress}}<br />
						</td>
					</tr>
					<tr bgcolor="f7f7f7">
