...
<script language="JavaScript">
	...
	$(document).ready(function() {
		var arr = {{$day_detailed}};
		getBar('day_detailed','host','服务器日志统计',arr);
		
		var arr = {{$day_count_srcip}};
		getBar('day_count_srcip','srcip','登录来源地址统计',arr);
		
		var arr = {{$day_count_server}};
		getBar('day_count_server','server','登陆服务器',arr);
		
		var arr = {{$day_count_protocol}};
		getBar('day_count_protocol','protocol','目标协议',arr);
		
		var arr = {{$day_level}};
		getPie('day_level','level','级别(天)',arr);
		
		var arr = {{$hour_level}};
		getLine('hour_level','date','级别(时)',arr);
	});
	...
	var data = new Array();
     for(var i=0; i<arr.length;i++){
	        ...
	        categories[i] = tmp_arr[0]+'<br>'+tmp_arr[1] ;
	...
	<tr >
					<td >
								<table width="100%" style="height:330px;"  class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="day_count_srcip" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td >
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="day_count_server" style="width: 100%; height:80%; margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td >
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="day_count_protocol" style="width: 100%; height:80%; margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
	...
	<tr >
					<td  width="33%" >
							<table width="100%"  style="height:330px;" class="BBtable">
									...
									<tr>
										<td  style="height:90%;" > 
										 <div id="day_detailed" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
					<td  width="33%">
								<table width="100%" style="height:330px;" class="BBtable">
									...
									<tr>
										<td style="height:90%;" >
										 <div id="day_level" style="width: 100%;height:80%;  margin: 1 auto"></div>
										</td>
									</tr>
								</table>
					</td>
