  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr >
          ...
          <td height="35" bgcolor="#528AC7" class="main_title">{{$language.ReportManager}}——审批报表</td>         
	...
	<td class="main_content">
		...
		<tr>
					...
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">用户名</th>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">系统用户名</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">登录协议</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">申请时间</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">审批时间</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">登录时间</th>
					</tr>
					{{section name=t loop=$reports}}
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						<td width="10%">{{$smarty.section.t.index+1}}</td>
						<td width="10%">{{$reports[t].webuser}}</td>
						...
						<td width="10%">{{$reports[t].login_method}}</td>
						<td width="10%">{{$reports[t].applytime}}</td>
						<td width="10%">{{$reports[t].approvetime}}</td>
						<td width="10%">{{$reports[t].logintime}}</td>	
					</tr>
					{{/section}}
