  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
					{{if $table == "login_day_count"}}
						<th class="list_bg" width="12%" bgcolor="d9ecfa" width="5%">日期</th>
					{{else }} 
						<th class="list_bg" width="12%" bgcolor="d9ecfa" >起始日期</th>
						<th class="list_bg" width="12%" bgcolor="d9ecfa" >结束日期</th>
					{{/if}}
						
						<th class="list_bg" width="9%"   bgcolor="d9ecfa" >主机</th>
						<th class="list_bg" width="9%"   bgcolor="d9ecfa" >用户</th>
						<th class="list_bg" width="12%"   bgcolor="d9ecfa" >来源地址</th>
						<th class="list_bg" width="9%"   bgcolor="d9ecfa" >协议</th>
						<th class="list_bg" width="9%"   bgcolor="d9ecfa" >状态</th>
						<th class="list_bg" width="9%"   bgcolor="d9ecfa" >数量</th>
