...
{{/if}}
</ul><span class="back_img"><A href="admin.php?controller=admin_autorun&action=auto_result&autorun_index_id={{$autorun_index_id}}&device_id={{$device.id}}&autotemplate_id={{$autotemplate.id}}&back=1"><IMG src="{{$template_root}}/images/back1.png" 
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
		<form name="f1" method=post action="admin.php?controller=admin_autorun&action=autobackup_delete&type={{$smarty.get.type}}">
			<tr>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=scriptpath&orderby2={{$orderby2}}" >序号</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=device_ip&orderby2={{$orderby2}}" >设备IP</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=hostname&orderby2={{$orderby2}}" >主机名</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=name&orderby2={{$orderby2}}" >脚本名称</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=scriptpath&orderby2={{$orderby2}}" >脚本</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=datetime&orderby2={{$orderby2}}" >执行时间</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=cmd&orderby2={{$orderby2}}" >指令</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=action&orderby2={{$orderby2}}" >动作</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=auto_result_detail&orderby1=result&orderby2={{$orderby2}}" >结果</a></th>
			</tr>
			...
			<td>{{$smarty.section.t.index+1}}</td>
				...
				<td>{{$autotemplate.name}}</td>
				<td>{{$autotemplate.scriptpath}}</td>
				<td>{{$alldev[t].datetime}}</td>
				<td>{{$alldev[t].cmd}}</td>
				<td>{{$alldev[t].action}}</td>
				<td>{{$alldev[t].result}}</td>
			</tr>
			{{/section}}
