  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr >
          ...
          <td height="35" bgcolor="#528AC7" class="main_title">{{$language.ReportManager}}——应用账号报表</td>         
	...
	<td class="main_content">
		...
		<tr>
					...
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">用户名</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">URL</th>
					</tr>
