...
{{if $smarty.session.ADMIN_LEVEL ne 3 and $smarty.session.ADMIN_LEVEL ne 21 and $smarty.session.ADMIN_LEVEL ne 101}}
	...
	{{/if}}
</ul><span class="back_img"><A href="admin.php?controller=admin_workflow&action=workflow_contant&back=1"><IMG src="{{$template_root}}/images/back1.png" 
  ...
  <tr>
	<td class="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BBtable">
          <tr>
            <td align="center"><form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_workflow&action=workflow_contant_save&sid={{$sip['sid']}}">
	...
	<tr bgcolor="f7f7f7">
		...
		<td width="67%">
		<input type=text name="name" size=35 value="{{$sip.name}}" >
	  </td>
	</tr>	
	<tr bgcolor="">
