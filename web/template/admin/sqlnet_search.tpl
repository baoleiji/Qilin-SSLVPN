...
<form method="get" name="session_search" action="admin.php">
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						<td>
							...
							<td width="100">
							<input type="radio" name="controller" value="admin_sqlnet" checked>Oracle{{$language.Session}}
							</td>
							<td width="100">
							...
							<input type="radio" name="controller" value="admin_http" onClick="location.href='admin.php?controller=admin_http&action=search'">Http{{$language.Session}}
							</td></tr></table>
