...
<ul>
  ...
  <tr>
	<td class="">
<form method="get" name="session_search" action="admin.php"><input type='hidden' name='action' value = 'view'>
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						...
						<td width="100">
							...
							<td width="100"><input type="radio" name="controller" value="admin_apppub" checked>应用URL</td><td><input type="radio" name="controller" value="admin_scp" onClick="location.href='admin.php?controller=admin_scp&action=search'">SCP</td><td></td><td></td><td></td><td></td>
						</tr></table>
						</td>
					</tr>
					<tr>
					...
					<tr bgcolor="f7f7f7">
						<td class="td_line" width="30%">URL：</td>
						<td class="td_line" width="70%"><input type="text" class="wbk" name="url"></td>
					</tr>
					<tr bgcolor="f7f7f7">
