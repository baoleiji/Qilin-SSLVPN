  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">{{$language.DeviceAddress}}</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">{{$language.protocol}}</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">{{$language.LocalUser}}{{$language.User}}</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">{{$language.WebUser}}{{$language.User}}</th>
						<th class="list_bg"  bgcolor="d9ecfa">{{if $number eq 3}}{{$language.fileoperate}}{{else}}{{$language.Command}}{{/if}}</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="8%">{{if $number == 1}}{{$language.Logintimes}}{{else}}{{$language.times}}{{/if}}</th>
					</tr>
