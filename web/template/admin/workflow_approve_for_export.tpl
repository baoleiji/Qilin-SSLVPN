  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						<th class="list_bg"  bgcolor="d9ecfa" width="8%">申请人</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="13%">申请时间</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%">设备IP</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%">用户名</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="8%">登录方式</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">操作内容</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="25%">描述</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="6%">流程状态</th>
					</tr>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td >{{if !$s[t].status }}未审批{{elseif $s[t].status eq 1}}关单{{elseif $s[t].status eq 2}}驳回{{elseif $s[t].status eq 3}}审批中{{elseif $s[t].status eq 4}}审批完成{{/if}}</td>
					</tr>
					{{/section}}
