	...
	<td class="" colspan = "7"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="main_content">
                ...
                <TBODY>
				 <TR>
				  ...
				  <th class="list_bg" >&nbsp;</th>
                    ...
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting&orderby1=dbactive&orderby2={{$orderby2}}">系统用户</a></th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting&orderby1=mysqluser&orderby2={{$orderby2}}">备份目录</a></th>
			...
			<tr  {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
				...
				<td>				
					...
					| <img src='{{$template_root}}/images/ico2.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_backup&action=backup_passwd_log&host={{$alldev[t].ip}}' >日志</a>
