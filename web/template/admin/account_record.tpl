  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr >
          ...
          <td height="35" bgcolor="#528AC7" class="main_title">{{$language.ReportManager}}——从账号报表</td>         
  ...
  <tr>
	<td class="main_content">
		...
		<tr>
					...
					<tr>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%"></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">时间</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">服务器IP</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">从帐号</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">UID</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">GID</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">主目录</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">动作</th>
					</tr>
					{{section name=t loop=$reports}}
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						<td width="10%">{{$smarty.section.t.index+1}}</td>
						<td width="10%">{{$reports[t].date}}</td>
						<td width="10%">{{$reports[t].ip}}</td>
						<td width="10%">{{$reports[t].user}}</td>
						<td width="10%">{{$reports[t].uid}}</td>
						<td width="10%">{{$reports[t].gid}}</td>
						<td width="10%">{{$reports[t].home}}</td>
						<td width="10%">{{$reports[t].action}}</td>
					</tr>
					{{/section}}
