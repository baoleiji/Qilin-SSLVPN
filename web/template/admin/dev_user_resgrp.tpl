	...
	<form name="member_list" action="admin.php?controller=admin_member&action=protect_lgroup_delete" method="post">
				<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					...
					<tr>
						...
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_member&action=protect_user_resgrp&uid={{$uid}}&orderby1=groupname&orderby2={{$orderby2}}" >{{$language.DeviceGroup}}</a></th>
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_member&action=protect_user_resgrp&uid={{$uid}}&orderby1=weektime&orderby2={{$orderby2}}" >{{$language.WeekTimepolicy}}</a></th>
						<th class="list_bg"  width="15%"><a href="admin.php?controller=admin_member&action=protect_user_resgrp&uid={{$uid}}&orderby1=sourceip&orderby2={{$orderby2}}" >{{$language.SourceIP}}</a></th>
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_member&action=protect_user_resgrp&uid={{$uid}}&orderby1=forbidden_commands_groups&orderby2={{$orderby2}}" >{{$language.Black}}</a></th>
