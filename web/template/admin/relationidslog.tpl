...
<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_relationlog&action=relationidslog">报警日志</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_relationlog&action=relationserverlog">主机日志</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>
  ...
  <tr>
    ...
    <FORM method=get name=f1   onSubmit="return false;"    action=admin.php>
      ...
      <INPUT id=action value=index type=hidden   name=a> 
		      ...
		      <INPUT  size="12" class="an_02"  onClick="JavaScript: document.getElementById('action').value='relationidslog';submit();" value=查找  type=button> 
	</FORM>
</td>
  </tr>
</table>	
  ...
  <table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
	 <FORM method=post name=list     action=admin.php?controller=admin_relationlog&amp;a=delete_all&amp;t=relationidslog>
					
				<tr>
			 	     <TH width="2%" class="list_bg">选</TH>
			          <TH width="2%" class="list_bg">ID</TH>
			          <TH width="9%" class="list_bg">报警设备</TH>
