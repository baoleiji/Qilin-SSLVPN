...
function searchit(){
	var url = "admin.php?controller=admin_reports&action=dangercmdlistreport";
...
<ul>
	...
	<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdreport">告警统计</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdlistreport">告警操作</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
</ul>
</div></td></tr>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=user&orderby2={{$orderby2}}" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=realname&orderby2={{$orderby2}}" >别名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=groupname&orderby2={{$orderby2}}" >运维组</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=device_ip&orderby2={{$orderby2}}" >服务器IP</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=type&orderby2={{$orderby2}}" >登录协议</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=luser&orderby2={{$orderby2}}" >系统用户</a></th>							
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=cmd&orderby2={{$orderby2}}" >告警命令</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=dangerlevel&orderby2={{$orderby2}}" >告警级别</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=at&orderby2={{$orderby2}}" >操作时间</a></th>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td width="10%">{{$reports[t].type}}</td>
						<td width="10%">{{$reports[t].luser}}</td>
						<td width="10%">{{$reports[t].cmd}}</td>
						<td width="10%">{{if $reports[t].dangerlevel eq 2}}断开连接{{elseif $reports[t].dangerlevel eq 3}}命令监控{{elseif $reports[t].dangerlevel eq 4}}授权命令{{else}}命令阻断{{/if}}</td>
						<td width="10%">{{$reports[t].at}}</td>
					</tr>
					{{/section}}
					<tr>
