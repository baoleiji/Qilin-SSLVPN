	...
	<td align="left" colspan = "7"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="main_content">
		...
		<TBODY>
		 <TR>
			...
			<option value="oracle_tablespace_monitor" selected >表空间</option>
      ...
      <tr  >
        <td class="" width="100%">
		  ...
		  <TABLE class=BBtable cellSpacing=0 cellPadding=0 width="100%"             align=center>
              ...
              <TR>
                <TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=device_ip&orderby2={{$orderby2}}">设备IP</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=hostname&orderby2={{$orderby2}}">主机名称</a></TD>
                <TD width="10%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=alarm&orderby2={{$orderby2}}">抓取时间</a></TD>
				<TD width="9%" class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=hostname&orderby2={{$orderby2}}">表空间名称</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=value&orderby2={{$orderby2}}">文件大小</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=alarm&orderby2={{$orderby2}}">剩余空间</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=alarm&orderby2={{$orderby2}}">邮件告警</a></TD>
                <TD width="9%"  class="list_bg"><a href = "admin.php?controller=admin_monitor&action=oracle_tablespace_monitor&orderby1=alarm&orderby2={{$orderby2}}">短信告警</a></TD>
		...
		<TD class="">{{$hosts[h].tablespace_name}}</TD>
		<TD class="" style="text-align:left">{{$hosts[h].file_size}}</TD>
		...
		<TD class="" style="text-align:left"><img src='{{$template_root}}/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_monitor&action=oracle_tablespace_monitor_edit&id={{$hosts[h].id}}'>修改</a></TD>		
	  </TR>
	{{sectionelse}}
	   <TR>
