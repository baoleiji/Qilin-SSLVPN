...
<li class="me_b"><img src="{{$template_root}}/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_log&action=applog_warning">应用告警</a><img src="{{$template_root}}/images/an33.jpg" align="absmiddle"/></li>  
  ...
  <table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
	 <FORM method=post name=list     action=admin.php?controller=admin_countlogs&amp;a=delete_all&amp;t=countlogs_month_detailed>
				<tr>
			 	       <TH width="3%" class="list_bg">选</TH>
			          <TH width="3%" class="list_bg">ID</TH>
			          <TH width="8%" class="list_bg"><a href="#"  onClick="searchit('host','{{$orderby2}}');">主机名</a></TH>
		          <TH  class="list_bg"><a href="#"  onClick="searchit('date_start','{{$orderby2}}');">开始时间</a></TH>
			          ...
			          <TH width="8%" class="list_bg"><a href="#"  onClick="searchit('DEBUG','{{$orderby2}}');">DEBUG</a></TH>
			          <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('INFO','{{$orderby2}}');">INFO</a></TH>
			          <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('NOTICE','{{$orderby2}}');">NOTICE</a></TH>
					  <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('WARNING','{{$orderby2}}');">WARNING</a></TH>
					   <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('ERR','{{$orderby2}}');">ERR</a></TH>
					    <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('CRIT','{{$orderby2}}');">CRIT</a></TH>
					    
					    <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('ALERT','{{$orderby2}}');">ALERT</a></TH>
					    <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('EMERG','{{$orderby2}}');">EMERG</a></TH>
					    <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('actionlog','{{$orderby2}}');">actionlog</a></TH>
					    <TH width="5%" class="list_bg"><a href="#"  onClick="searchit('alllog','{{$orderby2}}');">alllog</a></TH>
 					</tr>
...
location.href='admin.php?controller=admin_countlogs&action=export&table=log_countlogs_month_detailed&f_rangeStart='+f_rangeStart;

}

function export2(){
var f_rangeStart = document.getElementById("f_rangeStart").value;
location.href='admin.php?controller=admin_countlogs&action=derivetoHTML&table=log_countlogs_month_detailed&f_rangeStart='+f_rangeStart;
}
</script>
</body>
</html>
