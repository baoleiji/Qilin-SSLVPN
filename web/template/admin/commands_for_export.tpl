	...
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						...
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">堡垒机用户</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">设备用户</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">协议</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%">执行时间</th>
						<th class="list_bg"  bgcolor="d9ecfa" width="15%">命令</th>
					</tr>
					{{section name=t loop=$reports}}
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						<td width="10%">{{$reports[t].addr}}</td>
						<td width="10%">{{$reports[t].luser}}({{$reports[t].realname}})</td>
