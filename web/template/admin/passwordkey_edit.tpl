...
<ul>
	...
	{{/if}}
</ul><span class="back_img"><A href="admin.php?controller=admin_pro&action=passwordkey&back=1"><IMG src="{{$template_root}}/images/back1.png" 
	...
	<td class="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="center">
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_pro&action=passwordkey_save&id={{$passkey.id}}">
	...
	<tr bgcolor="f7f7f7">
		...
		<td width="67%">
		<input type = text name="key_str" value="{{$passkey.key_str}}" style="width:300px;">
	  </td>
	</tr>
	<tr bgcolor="">
		<td width="33%" align=right>
		...
		<td width="67%">
		<input type = text name="zip_file" value="{{$passkey.zip_file}}" style="width:300px;">
	  </td>
	</tr>
	<tr>
		<td></td>
