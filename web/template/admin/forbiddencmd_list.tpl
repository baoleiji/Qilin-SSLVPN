...
<body>
  ...
  <tr>
	<td class=""><table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				<th class="list_bg"  width="35%">地址</th>
				<th class="list_bg"  width="20%">radius用户</th>
			...
			<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
				...
				<td>{{$allcommand[t].radius_user}}</ td>
				<td>{{$allcommand[t].cmd}}</ td>
				<td><img src="{{$template_root}}/images/scico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_session&action=del_forbiddencmd&cid={{$allcommand[t].cid}}">删除</a></td>
			</tr>
			{{/section}}
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					...
					<input type="button" onclick="location.href='admin.php?controller=admin_session&action=forbiddencms_edit'"  value="增加">
