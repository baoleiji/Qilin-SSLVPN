    ...
    <td height="12" valign="top" background="{{$template_root}}/images/yw_03.jpg"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="center" valign="top">
			...
			<div class="cj" >
				<ul>
				<li><span class="td5"><a href="admin.php?controller=admin_index" onclick="return changeCactiMenu(this, 'audit')"></a></span><span class="cj_zi"></span></li>
				{{if $dbaudit_on}}<li><span class="td5"><a href="dbaudit" ><img src="{{$template_root}}/images/db.png" /></a></span><span class="cj_zi">DB审计</span></li>{{/if}}	
				{{if $named_on}}<li><span class="td5"><a href="../named/main.php?FROMAUDIT=1" ><img src="{{$template_root}}/images/home.png" /></a></span><span class="cj_zi">DNS</span></li>{{/if}}	
				</ul>
			</div>
					</td>
					
{{if $user.webportal}}<TD width="150" background="images/yw_03.jpg">
<div id="timer" style="color:#ffffff; text-align:left;"></div>      
        ...
        <td width="200" align="right" valign="top"><table width="200" height="31" border="0" cellpadding="0" cellspacing="0" class="lj_hei">
          <tr>
            ...
            <td align="center" bgcolor="ADDEFE" ><ul id="navigation"> <li><a href="admin.php?controller=admin_index"><img src="{{$template_root}}/images/yw_07.jpg" width="16" height="16" align="absmiddle" />主页</a></li><li><a href="admin.php?controller=admin_index&amp;action=logout"><img src="{{$template_root}}/images/yw_09.jpg" width="15" height="16" align="absmiddle" />退出</a></li></ul></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr><td width="230" align="left" valign="top" id="left" >
	   <iframe id="menu" name="menu" src="admin.php?controller=admin_index&amp;action=menu&actions={{$smarty.get.actions}}&ldapid={{$smarty.get.ldapid}}&back={{$smarty.get.back}}" marginwidth="0"  framespacing="0" marginheight="0" height="700" frameborder="0" width="230" allowtransparency="true" scrolling="auto" ></iframe>
	</td>
