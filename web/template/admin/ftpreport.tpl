...
function searchit(){
	var url = "admin.php?controller=admin_reports&action=ftpreport";
...
{{else}}
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=ftpreport&number=6">FTP{{$language.Command}}{{$language.report}}</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
{{/if}}
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=radius_user&orderby2={{$orderby2}}" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=realname&orderby2={{$orderby2}}" >别名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=ug.groupname&orderby2={{$orderby2}}" >运维组</a></th>
						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=ftp_user&orderby2={{$orderby2}}" >系统用户</a></th>						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=putct&orderby2={{$orderby2}}" >上载次数</a></th>						
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=getct&orderby2={{$orderby2}}" >下载次数</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=ct&orderby2={{$orderby2}}" >命令次数</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=mstart&orderby2={{$orderby2}}" >开始日期</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=ftpreport&orderby1=mend&orderby2={{$orderby2}}" >结束日期</a></th>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td width="10%">{{$reports[t].ftp_user}}</td>
