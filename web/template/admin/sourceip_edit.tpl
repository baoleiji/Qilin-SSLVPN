  ...
  <tr>
	<td class="">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BBtable">
          <tr>
            <td align="center"><form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_pro&action=sourceip_save&sid={{$sip['sid']}}">
	...
	<tr bgcolor="f7f7f7">
		...
		<td width="67%">
		<input type=text name="groupname" size=35 value="{{$sip.groupname}}" >
	  </td>
	</tr>	
	<tr bgcolor="f7f7f7">
		<td width="33%" align=right>
		...
		<td width="67%">
		<select name="ipv6" {{if $sip['sid']}}readOnly{{/if}} >
		<option value="0" {{if !$sip.ipv6}}selected{{/if}}>IPv4</option>
		<option value="1" {{if $sip.ipv6}}selected{{/if}}>IPv6</option>
		</select>
	  </td>
	</tr>	
	<tr bgcolor="">
	<td width="33%" align=right valign="top">
		...
		<td width="67%">
		<textarea cols="37" rows="10"  name="description">{{$sip.description}}</textarea>
	  </td>
	</tr>	
