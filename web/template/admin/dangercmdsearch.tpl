...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=dangercmdlistreport";
...
<ul>
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=cmdlistreport">高危列表</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
