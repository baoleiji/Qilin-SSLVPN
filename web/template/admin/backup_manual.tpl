...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_backup&action=backup_manual">
	<tr><th colspan="3" class="list_bg"></th></tr>
	<tr><td align="right">备份数据的时间:</td>
		<td align=left>&nbsp;
		<input type="text" class="wbk" name="backuptime" value="" />
		</td>
		
	</tr>
	<tr bgcolor="f7f7f7"><td align="right">是否上传:</td>
		<td align=left>&nbsp;
		<select  class="wbk"  name="isupload" >
