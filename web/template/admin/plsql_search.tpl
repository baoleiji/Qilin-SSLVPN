...
<body>
 ...
 <tr><td valign="middle" class="hui_bj"> 
<div class="menu">
<ul>
...
<form method="get" name="session_search" action="admin.php">
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						...
						<td width="100">
							<input type="radio" name="controller" value="admin_apppub"  >应用{{$language.Session}}
							</td></tr>
						<tr >
						<td width="100">
							<input type="radio" name="controller" value="admin_apppub" checked onClick="location.href='admin.php?controller=admin_apppub&action=plsql_search'">SQL查询
							</td>
					...
					<tr>
						<td class="td_line" width="30%">SQL语句：</td>
						<td class="td_line" width="70%">
							<input name="sqltext" type="text" class="wbk" /><br />
						</td>
					</tr>
					<tr bgcolor="f7f7f7">
				...
				<input type="hidden" name="appname" value="plsql" />
			</form>
	</td>
  </tr>
</table>
