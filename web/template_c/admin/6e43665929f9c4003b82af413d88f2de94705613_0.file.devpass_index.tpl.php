<?php /* Smarty version 3.1.27, created on 2016-12-04 12:29:20
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/devpass_index.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:128822177458439ba0c8a720_09311466%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e43665929f9c4003b82af413d88f2de94705613' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/devpass_index.tpl',
      1 => 1474793220,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128822177458439ba0c8a720_09311466',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_58439ba0d5eee5_63922256',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_58439ba0d5eee5_63922256')) {
function content_58439ba0d5eee5_63922256 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '128822177458439ba0c8a720_09311466';
?>
	...
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
                <TBODY>
                  ...
                  <th class="list_bg"  width="1%">ID</th>
                    <th class="list_bg" ><?php echo $_smarty_tpl->tpl_vars['language']->value['HostName'];?>
</TD>
                    <th class="list_bg" >IP</TD>
                    <th class="list_bg" ><?php echo $_smarty_tpl->tpl_vars['language']->value['System'];?>
</TD>
					<th class="list_bg" ><?php echo $_smarty_tpl->tpl_vars['language']->value['System'];
echo $_smarty_tpl->tpl_vars['language']->value['User'];?>
</TD>
                    <th class="list_bg" ><?php echo $_smarty_tpl->tpl_vars['language']->value['Loginmode'];?>
</TD>
                    <th class="list_bg" >账号信息</TD>
...
/images/1-1.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><?php echo smarty_modifier_truncate_cn($_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['desc'],5,"...",'');?>
</a></td>
				<td>
...
');if(chk_form()) document.member_list.action='admin.php?controller=admin_pro&action=devpass_del&from=dev_priority_search'; else return false;" class="an_02">&nbsp;&nbsp;<input type="button"  value="批量添加" onClick="location.href='admin.php?controller=admin_pro&action=pass_batchedit&ip=<?php echo $_smarty_tpl->tpl_vars['ip']->value;?>
&serverid=<?php echo $_smarty_tpl->tpl_vars['serverid']->value;?>
&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
'" class="an_02">
		   </td>
              
	           <td  colspan="5" align="right">&nbsp;<input type="button"  value="锁定" onClick="batchloginlock();" class="an_02">&nbsp;&nbsp;&nbsp;
...
/images/excel.png" border=0></a><?php }?>&nbsp&nbsp;&nbsp;<input type="button"  value="导出该主机下的用户" onClick="location.href='<?php echo $_smarty_tpl->tpl_vars['curr_url']->value;?>
