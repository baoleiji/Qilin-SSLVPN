<?php /* Smarty version 3.1.27, created on 2016-12-21 16:52:38
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/forbiddengps_group.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:84167643585a42d640e0a8_41164976%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7fe4301abc9c8818fe0f7ee4a8eaa9db64dc397d' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/forbiddengps_group.tpl',
      1 => 1474793221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '84167643585a42d640e0a8_41164976',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_585a42d64950e8_42427849',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_585a42d64950e8_42427849')) {
function content_585a42d64950e8_42427849 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '84167643585a42d640e0a8_41164976';
?>
...
<ul><?php if ($_SESSION['ADMIN_LEVEL'] != 3 && $_SESSION['ADMIN_LEVEL'] != 21 && $_SESSION['ADMIN_LEVEL'] != 101) {?>
...
/images/back1.png" 
  ...
  <tr>
	<td class=""><table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				<th class="list_bg"  width="35%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_group&orderby1=device_ip&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >地址</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_group&orderby1=GroupName&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >运维组</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_group&orderby1=forbidden_commands_groups&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" ><?php echo $_smarty_tpl->tpl_vars['language']->value['groupname'];?>
</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_group&orderby1=weektime&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" ><?php echo $_smarty_tpl->tpl_vars['language']->value['Time'];
echo $_smarty_tpl->tpl_vars['language']->value['List'];?>
</a></th>
			</tr>
...
?>
			<tr <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				...
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['weektime'];?>
</td>
