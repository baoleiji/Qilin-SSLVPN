<?php /* Smarty version 3.1.27, created on 2016-12-27 00:08:23
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/ftpsession_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:59970550458614077282d18_34939348%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0a2f185b4951c22a3bdcbc850ab4dce9137c40e' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/ftpsession_list.tpl',
      1 => 1479352795,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '59970550458614077282d18_34939348',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5861407736b4c0_48500745',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5861407736b4c0_48500745')) {
function content_5861407736b4c0_48500745 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '59970550458614077282d18_34939348';
?>
...
function searchit(){
	var url = "admin.php?controller=admin_ftp&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
";
	url += "&d_addr="+document.search.elements.ip.value;
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_ftp&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
...
/images/an33.jpg" align="absmiddle"/></li> 
   ...
   <tr>
       ...
       <td >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_content"><form action="admin.php?controller=admin_ftp&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
...
<input  type="text" class="wbk" name="f_rangeEnd" size="13" id="f_rangeEnd" value="" />
 <input type="button" onClick="changetype('timetype3')" id="f_rangeEnd_trigger" name="f_rangeEnd_trigger" value="选择时间" class="wbk">
	  &nbsp;&nbsp;<input type="submit" height="35" align="middle" onClick="return searchit();" border="0" value=" 确定 " class="bnnew2"/>&nbsp;&nbsp;<input id="filtercheck" type="checkbox" onclick="filter1();" name="filter" value="1" <?php if ($_smarty_tpl->tpl_vars['filter']->value) {?>checked<?php }?> >过滤
 </td>
  </tr></form>
</table>
...
>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=cliaddr&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">来源地址</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=svraddr&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['DestinationAddress'];?>
</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=radius_user&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">运维</a></th>	
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=realname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
">真实姓名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=ftp_user&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['LocalUser'];?>
</a></th>					
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=start&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['StartTime'];?>
</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=end&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['EndTime'];?>
</a></th>
						<th class="list_bg"   width="18%"><a href="admin.php?controller=admin_ftp&orderby1=addr&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['Detail'];?>
</th>
					</tr>
...
?>
					...
					<td><a href="admin.php?controller=admin_ftp&cliaddr=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['cliaddr'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['cliaddr'];?>
</a></td>
						
						<td><a href="admin.php?controller=admin_ftp&svraddr=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['svraddr'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['svraddr'];?>
</a></td>
						
						<td><a href="admin.php?controller=admin_ftp&radius_user=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['radius_user'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['radius_user'];?>
</a></td>
						<td><a href="admin.php?controller=admin_ftp&realname=<?php echo urlencode($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['realname']);?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['realname'];?>
</a></td>
						<td><a href="admin.php?controller=admin_ftp&ftp_user=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['ftp_user'];?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['ftp_user'];?>
</a></td>
...
/images/ico2.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_ftp&action=view&sid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
&command=<?php echo $_smarty_tpl->tpl_vars['command']->value;?>
&backupdb_id=<?php echo $_smarty_tpl->tpl_vars['backupdb_id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['language']->value['View'];?>
</a>(命令条数:<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['total_cmd'];?>
)
...
&action=logindesc&type=ftp&sessionid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
...
&action=logincommit&type=ftp" target="hide" >说明</a><?php }?>

						<?php if (0) {?> <?php if (!$_smarty_tpl->tpl_vars['backupdb_id']->value) {?>| <img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/cross.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_ftp&action=del_session&sid=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
