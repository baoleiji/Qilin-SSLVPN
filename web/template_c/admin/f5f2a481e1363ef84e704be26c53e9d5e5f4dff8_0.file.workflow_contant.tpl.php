<?php /* Smarty version 3.1.27, created on 2016-12-04 20:56:45
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/workflow_contant.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:15434745095844128d4e30a5_46806040%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5f2a481e1363ef84e704be26c53e9d5e5f4dff8' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/workflow_contant.tpl',
      1 => 1474793220,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15434745095844128d4e30a5_46806040',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5844128d55cfb8_02377993',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5844128d55cfb8_02377993')) {
function content_5844128d55cfb8_02377993 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '15434745095844128d4e30a5_46806040';
?>
	...
	<form name="ip_list" action="admin.php?controller=admin_workflow&action=workflow_contant_delete" method="post">
                <TBODY>
                  <TR>
                    ...
                    <th class="list_bg" width="5%"><a href="admin.php?controller=admin_workflow&action=workflow_contant&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >选</a></TD>
                    <th class="list_bg"  width="20%"><a href="admin.php?controller=admin_workflow&action=workflow_contant&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >名称</a></TD>
                    <th class="list_bg"  width="30%"><a href="admin.php?controller=admin_workflow&action=workflow_contant&orderby1=groupname&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >描述</a></TD>
...
?>
			<tr  <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				<td width="5%"><?php if ($_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['status']) {?><input type="checkbox" name="chk_gid[]" value="<?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
"><?php }?></td>
				...
				<td style="TEXT-ALIGN: left;"><?php if ($_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['status']) {?><img src='<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_workflow&action=workflow_contant_edit&sid=<?php echo $_smarty_tpl->tpl_vars['s']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
