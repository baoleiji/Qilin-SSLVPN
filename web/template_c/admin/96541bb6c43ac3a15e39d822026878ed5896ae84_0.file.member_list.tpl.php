<?php /* Smarty version 3.1.27, created on 2017-08-25 09:57:25
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/member_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1137671473599f840506fda4_25957199%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96541bb6c43ac3a15e39d822026878ed5896ae84' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/member_list.tpl',
      1 => 1503573319,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1137671473599f840506fda4_25957199',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599f84051b31b1_02571455',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599f84051b31b1_02571455')) {
function content_599f84051b31b1_02571455 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1137671473599f840506fda4_25957199';
?>
...
' ><?php if ($_smarty_tpl->tpl_vars['allmember']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['level'] == 0) {?>认证<?php echo $_smarty_tpl->tpl_vars['language']->value['User'];
...
echo $_smarty_tpl->tpl_vars['language']->value['Administrator'];
} elseif ($_smarty_tpl->tpl_vars['allmember']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['level'] == 21) {?>部门审计员<?php } elseif ($_smarty_tpl->tpl_vars['allmember']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['level'] == 101) {?>部门密码员<?php } elseif ($_smarty_tpl->tpl_vars['allmember']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['level'] == 11) {?>认证用户<?php } else {
...
"><?php echo $_smarty_tpl->tpl_vars['language']->value['Edit'];?>
						...
						|&nbsp;<img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/file.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_pro&action=resource_group_edit&uid=<?php echo $_smarty_tpl->tpl_vars['allmember']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['uid'];?>
">权限</a>
...
');if(chk_form()) document.member_list.action='admin.php?controller=admin_member&action=delete_all'; else return false;" class="an_02">&nbsp;&nbsp;<input type="submit"  value="批量编辑" onClick="javascript:document.member_list.action='admin.php?controller=admin_member&action=batchpriorityedit'" class="an_02">
							&nbsp;&nbsp;
