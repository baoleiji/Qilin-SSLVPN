<?php /* Smarty version 3.1.27, created on 2016-12-04 20:10:19
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/sshkey_new.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:846361453584407ab8b10e5_54471450%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b53aae5b0d34d297de1ab9371a481b3cc82bfa6' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/sshkey_new.tpl',
      1 => 1474793221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '846361453584407ab8b10e5_54471450',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_584407ab921fe1_09739658',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_584407ab921fe1_09739658')) {
function content_584407ab921fe1_09739658 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '846361453584407ab8b10e5_54471450';
?>
  ...
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
                <TBODY>
                  ...
                  <TR>
					<th class="list_bg">&nbsp;</th>
                    <th class="list_bg" ><a href="admin.php?controller=admin_pro&action=sshkey_new&orderby1=device_ip&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >运维用户</a></th>
					<th class="list_bg" ><a href="admin.php?controller=admin_pro&action=sshkey_new&orderby1=dusername&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >设备IP</a></th>
...
?>
			<tr  <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				<td><input type="checkbox" name="chk_member[]" value="<?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
"></td>	
				<td> <a href='admin.php?controller=admin_pro&action=sshkey_new&device_ip=<?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['device_ip'];?>
'><?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['webuser'];?>
</a></td>
				<td> <a href='admin.php?controller=admin_pro&action=sshkey_new&hostname=<?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['hostname'];?>
'><?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['device_ip'];?>
</a></td>
				<td> <a href='admin.php?controller=admin_pro&action=sshkey_new&hostname=<?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['hostname'];?>
'><?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['port'];?>
</a></td>
				<td> <a href='admin.php?controller=admin_pro&action=sshkey_new&hostname=<?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['hostname'];?>
'><?php echo $_smarty_tpl->tpl_vars['sshdevices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['username'];?>
</a></td>
