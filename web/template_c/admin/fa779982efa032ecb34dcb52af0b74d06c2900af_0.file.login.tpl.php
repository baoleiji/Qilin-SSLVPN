<?php /* Smarty version 3.1.27, created on 2017-08-25 09:55:56
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/login.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:509321578599f83ac8dfbf1_07089840%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa779982efa032ecb34dcb52af0b74d06c2900af' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/login.tpl',
      1 => 1498461349,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '509321578599f83ac8dfbf1_07089840',
  'variables' => 
  array (
    'template_root' => 0,
    'dpwdtime' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599f83ac9f9a48_84008695',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599f83ac9f9a48_84008695')) {
function content_599f83ac9f9a48_84008695 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '509321578599f83ac8dfbf1_07089840';
?>
...
<input type="text" name="username" id="username"  onblur="changeusername(this.value,'u');" <?php if ($_smarty_tpl->tpl_vars['nametype']->value == 'realname') {?>disabled='disabled'<?php }?>  style="width: <?php if (1 || !$_smarty_tpl->tpl_vars['logintype']->value['ldapauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['radiusauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['adauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['fingersecauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['localfingersecauth'] || !$_smarty_tpl->tpl_vars['loginauthtype']->value || !$_smarty_tpl->tpl_vars['loginauthtype']->value) {?>200<?php } else { ?>100<?php }?>px;<?php if (!$_smarty_tpl->tpl_vars['dpwdtime']->value) {?>height:24px;<?php }
if ($_smarty_tpl->tpl_vars['nametype']->value == 'realname') {?>display:none<?php }?>">
<input type="text" name="username" id="realname"  onblur="changeusername(this.value,'r');" <?php if ($_smarty_tpl->tpl_vars['nametype']->value == 'username' || !$_smarty_tpl->tpl_vars['nametype']->value) {?>disabled='disabled'<?php }?>  style="width: <?php if (1 || !$_smarty_tpl->tpl_vars['logintype']->value['ldapauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['radiusauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['adauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['fingersecauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['localfingersecauth'] || !$_smarty_tpl->tpl_vars['loginauthtype']->value || !$_smarty_tpl->tpl_vars['loginauthtype']->value) {?>200<?php } else { ?>100<?php }?>px;<?php if (!$_smarty_tpl->tpl_vars['dpwdtime']->value) {?>height:24px;<?php }
...
<?php if (1 || !$_smarty_tpl->tpl_vars['logintype']->value['ldapauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['radiusauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['adauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['fingersecauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['localfingersecauth']) {?>
