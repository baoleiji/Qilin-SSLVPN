<?php /* Smarty version 3.1.27, created on 2017-05-16 22:11:06
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/groupadddev.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1487632234591b087a809110_50087946%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8960bb2fddbb9432655ad26d2189ce8458849922' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/groupadddev.tpl',
      1 => 1483239516,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1487632234591b087a809110_50087946',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_591b087a96ca59_66570039',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_591b087a96ca59_66570039')) {
function content_591b087a96ca59_66570039 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '1487632234591b087a809110_50087946';
?>
...
>
function searchit(){
	var url = "admin.php?controller=admin_pro&action=groupadddev&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
";
...
/images/an33.jpg" align="absmiddle"/></li>
	<?php }?>
<?php }?>
</ul><?php if ($_smarty_tpl->tpl_vars['from']->value == 'dir') {?><span class="back_img"><A href="admin.php?controller=admin_pro&action=dev_index&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&from=dir&back=1"><IMG src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/back1.png" 
  ...
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
          <tr>
            <td align="center"><form name="f1" method=post action="admin.php?controller=admin_pro&action=groupadddev_save&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
">
	<table border=0 width=100% cellpadding=5 cellspacing=1 bgcolor="#FFFFFF" valign=top>
	<tr><td colspan="1">组名:<?php echo $_smarty_tpl->tpl_vars['groupinfo']->value['groupname'];?>
</td><td colspan="7">IP:&nbsp;<input type="text" class="wbk" name="ip">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['g']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['alldev']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
	  <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['g']['iteration']%6 == 1) {?>
		<tr <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['g']['index']%12 != 0) {?>bgcolor="f7f7f7"<?php }?>>
		<?php }?>
		<td>		
		<input type="checkbox" name='id[]' value='<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['g']['index']]['id'];?>
' ><span title="<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['g']['index']]['hostname'];?>
"><?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['g']['index']]['device_ip'];?>
(<?php echo smarty_modifier_truncate_cn($_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['g']['index']]['hostname'],"10","...");?>
)</span>
	  </td>
	  <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['g']['iteration']%6 == 0) {?>
	  </tr>
	  <?php }?>
	  <?php endfor; endif; ?>
