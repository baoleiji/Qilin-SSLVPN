<?php /* Smarty version 3.1.27, created on 2016-12-31 19:46:07
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/vpnlogonline_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:18635058258679a7f467a27_89910351%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17c85856b49aee37135fdcf9463a16017b51d692' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/vpnlogonline_list.tpl',
      1 => 1476870537,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18635058258679a7f467a27_89910351',
  'variables' => 
  array (
    'template_root' => 0,
    'orderby2' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_58679a7f4dcbc3_28259688',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_58679a7f4dcbc3_28259688')) {
function content_58679a7f4dcbc3_28259688 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '18635058258679a7f467a27_89910351';
?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_vpnlog&action=online">在线用户</a><img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
 ...
 <tr>
	<td class="">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					...
					<tr>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%"><a href="admin.php?controller=admin_vpnlog&action=online&orderby1=user&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >用户</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="5%"><a href="admin.php?controller=admin_vpnlog&action=online&orderby1=src_ip&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >源ip</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%"><a href="admin.php?controller=admin_vpnlog&action=online&orderby1=in_time&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >连接时间</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%"><a href="admin.php?controller=admin_vpnlog&action=online&orderby1=out_time&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >发送字节</a></th>
						<th class="list_bg"  bgcolor="d9ecfa" width="10%"><a href="admin.php?controller=admin_vpnlog&action=online&orderby1=out_time&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >接收字节</a></th>
...
?>
					<tr <?php if ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 1) {?>bgcolor="red"<?php } elseif ($_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['dangerous'] > 0) {?>bgcolor="yellow" <?php } elseif ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
						<td><a href="admin.php?controller=admin_vpnlog&action=online&user=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['user'];?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][0];?>
</a></td>
						<td><a href="admin.php?controller=admin_vpnlog&action=online&fromip=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['src_ip'];?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][1];?>
</a></td>
						<td><a href="admin.php?controller=admin_vpnlog&action=online&toip=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['time'];?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][2];?>
</a></td>
						<td><a href="admin.php?controller=admin_vpnlog&action=online&toip=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sends'];?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][3];?>
</a></td>
						<td><a href="admin.php?controller=admin_vpnlog&action=online&toip=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['receives'];?>
"><?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][4];?>
</a></td>
						<td><a href="admin.php?controller=admin_vpnlog&action=cut&username=<?php echo $_smarty_tpl->tpl_vars['allsession']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']][0];?>
">断开</a></td>
						</tr>
