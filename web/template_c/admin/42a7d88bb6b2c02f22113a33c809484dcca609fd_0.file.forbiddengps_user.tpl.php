<?php /* Smarty version 3.1.27, created on 2016-12-21 16:48:15
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/forbiddengps_user.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1667580140585a41cf3db326_45611684%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42a7d88bb6b2c02f22113a33c809484dcca609fd' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/forbiddengps_user.tpl',
      1 => 1474793217,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1667580140585a41cf3db326_45611684',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_585a41cf4640d6_86177995',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_585a41cf4640d6_86177995')) {
function content_585a41cf4640d6_86177995 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1667580140585a41cf3db326_45611684';
?>
...
/images/back1.png" 
  ...
  <tr>
	<td class=""><table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_user&orderby1=device_ip&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >地址</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_user&orderby1=hostname&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >主机名</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_user&orderby1=username&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" >系统用户</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_user&orderby1=username&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
" ><?php echo $_smarty_tpl->tpl_vars['language']->value['User'];?>
				...
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_forbidden&action=forbiddengps_user&orderby1=forbidden_commands_groups&gid=<?php echo $_smarty_tpl->tpl_vars['gid']->value;?>
&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
...
?>
			<tr <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['t']['index']%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['device_ip'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['hostname'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sysuser'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['username'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['allcommand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['forbidden_commands_groups'];?>
</td>					
			</tr>
			<?php endfor; endif; ?>
			<tr>
