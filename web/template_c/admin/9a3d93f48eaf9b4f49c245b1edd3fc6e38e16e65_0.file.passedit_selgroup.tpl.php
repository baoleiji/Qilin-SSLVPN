<?php /* Smarty version 3.1.27, created on 2016-12-04 20:10:04
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/passedit_selgroup.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:570911085844079c148a16_71391847%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a3d93f48eaf9b4f49c245b1edd3fc6e38e16e65' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/dep10/template/admin/passedit_selgroup.tpl',
      1 => 1474793220,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '570911085844079c148a16_71391847',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5844079c22b750_39084256',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5844079c22b750_39084256')) {
function content_5844079c22b750_39084256 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '570911085844079c148a16_71391847';
?>
              ...
              <TABLE width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" valign="top"  class="BBtable">
				...
				<?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable(0, null, 0);?>
                  ...
                  <TR id="autosutr"  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
                    ...
                    <TD><INPUT id="autosu" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['autosu'] == 1) {?> checked <?php }?> type=checkbox name=autosu value="on">                      </TD>
                  </TR>
                  <TR id="autosutr"  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
                    <TD width="50%" align="right"><?php echo $_smarty_tpl->tpl_vars['language']->value['syslogAlertwhenloginin'];?>
</TD>
                    <TD><INPUT id="syslogalert" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['syslogalert'] == 1) {?> checked <?php }?> type=checkbox name=syslogalert value="on">                  </TD>
                  </TR>
                  <TR id="autosutr"  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
                    <TD width="50%" align="right"><?php echo $_smarty_tpl->tpl_vars['language']->value['mailalertwhenloginin'];?>
</TD>
                    <TD><INPUT id="mailalert" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['mailalert'] == 1) {?> checked <?php }?> type=checkbox name=mailalert value="on">              </TD>
                  </TR>
                  <TR id="autosutr"  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
                    <TD width="50%" align="right"><?php echo $_smarty_tpl->tpl_vars['language']->value['accountlocked'];?>
 </TD>
                    <TD><INPUT id="loginlock" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['loginlock'] == 1) {?> checked <?php }?> type=checkbox name=loginlock value="on">                    </TD>
                  </TR>
...
" <?php if ($_smarty_tpl->tpl_vars['allforbiddengroup']->value[$_smarty_tpl->getVariable('smarty')->value['section']['f']['index']]['gname'] == $_smarty_tpl->tpl_vars['lgroup']->value['forbidden_commands_groups']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['allforbiddengroup']->value[$_smarty_tpl->getVariable('smarty')->value['section']['f']['index']]['gname'];?>
...
" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['restrictacl'] == $_smarty_tpl->tpl_vars['acl']->value[$_smarty_tpl->getVariable('smarty')->value['section']['a']['index']]['id']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['acl']->value[$_smarty_tpl->getVariable('smarty')->value['section']['a']['index']]['aclname'];?>
</option>
					<?php endfor; endif; ?>
					</select> </TD>
                  </TR>
				 <TR  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
                    ...
                    <TD><INPUT id="twoauth" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['twoauth'] == 1) {?> checked <?php }?> type=checkbox onclick="checktwo(this.checked);" name=twoauth value="on"></TD>
                  </TR>
				   <TR  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="wf_2">
                    <TD width="50%" align="right">登录短信告警</TD>
                    <TD><INPUT id="smsalert" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['smsalert'] == 1) {?> checked <?php }?> type=checkbox name=smsalert value="on">           </TD>
                  </TR>
				  <TR  <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="wf_2">
                    <TD width="50%" align="right">流程审批</TD>
                    <TD><INPUT id="workflow" onclick="sworkflow(this.checked);" <?php if ($_smarty_tpl->tpl_vars['lgroup']->value['workflow'] == 1) {?> checked <?php }?> type=checkbox name=workflow value="on">           </TD>
                  </TR>
...
" <?php if ($_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'] == $_smarty_tpl->tpl_vars['lgroup']->value['wf_user1']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['username'];?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
...
?>
				<option value="<?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'];?>
" <?php if ($_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'] == $_smarty_tpl->tpl_vars['lgroup']->value['wf_user2']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['username'];?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
...
?>
				<option value="<?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'];?>
" <?php if ($_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'] == $_smarty_tpl->tpl_vars['lgroup']->value['wf_user3']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['username'];?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
...
?>
				<option value="<?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'];?>
" <?php if ($_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'] == $_smarty_tpl->tpl_vars['lgroup']->value['wf_user4']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['username'];?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
...
?>
				<option value="<?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'];?>
" <?php if ($_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['uid'] == $_smarty_tpl->tpl_vars['lgroup']->value['wf_user5']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['webusers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']]['username'];?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
...
<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['lgroup']->value['id'];?>
" />
